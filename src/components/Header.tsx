          ...
          <nav className="hidden lg:flex items-center gap-8">
            <NavigationMenu>
              <NavigationMenuList className="gap-2">
                ...
                <NavigationMenuItem>
                  <NavigationMenuLink asChild>
                    <Link to="/find-a-partner" className="px-4 py-2 text-sm font-medium text-foreground hover:text-primary transition-colors">
                      Partners
                    </Link>
                  </NavigationMenuLink>
                </NavigationMenuItem>
      ...
      {isMenuOpen && (
        <div className="lg:hidden bg-background border-t border-border">
          <nav className="container mx-auto px-4 py-4 space-y-4">
            ...
            <Link to="/find-a-partner" className="block py-2 text-foreground hover:text-primary">Partners</Link>
